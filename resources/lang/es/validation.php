...
return [
    ...
    */
    'custom' => [
        'nombre_pareja' => [
            'required' => 'El nombre de tu pareja es obligatorio si has indicado que asiste contigo.',
        ],
        'numero_hijos' => [
            'required' => 'Debes indicar cuántos hijos asistirán.',
            'min' => 'Debe haber al menos 1 hijo.',
        ],
        'nombres_hijos' => [
            'required' => 'Debes escribir los nombres de tus hijos.',
        ],
    ],
    ...
    */
    'attributes' => [
        ...
        'nombres_hijos' => 'nombres de los hijos',
    ],
